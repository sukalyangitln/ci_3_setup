                                    ...
                                    <div class="card-body">
                                        <ul class="nav nav-pills nav-justified" role="tablist" style="background-color: #ccc;">
                                            ...
                                            <li class="nav-item waves-effect waves-light">
                                                <a class="nav-link" data-bs-toggle="tab" href="#show_list_datatable" role="tab">
                                                    ...
                                                    <span class="d-none d-sm-block"><i class="fa fa-users"></i> Category List</span> 
                                                </a>
                                            </li>
                                        </ul>
                                        <!-- Tab panes -->
                                        <div class="tab-content p-3 text-muted">
                                            <div class="tab-pane active" id="add_form" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <?=form_open('admin/categories/add','name="insert-form" method="post"');?>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                            ...
                                            <div class="tab-pane" id="show_list_datatable" role="tabpanel">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="min-width:130px;">
                                                                    ...
                                                                    <a href="javascript:void(0);" onclick="edit_this('<?=encr($list->cid);?>');" class="btn btn-primary btn-sm br-0"><i class="fa fa-edit"></i></a>
                                                                    <a href="javascript:void(0);" onclick="delete_this('<?=encr($list->cid);?>');" class="btn btn-danger btn-sm br-0"><i class="fa fa-trash"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php $st++; endforeach; ?>
                                                ...
                                                <?=form_open('admin/categories/delete','method="get" name="delete_form"');?>
                                                <input type="hidden" name="encr_category_id">
                                                <?=form_close();?>
                                                <?=form_open('admin/categories/edit','method="get" name="edit_form"');?>
                                                <input type="hidden" name="edt_encr_category_id">
                                                <?=form_close();?>
                                            </div>
                                        </div>
                                    </div>
